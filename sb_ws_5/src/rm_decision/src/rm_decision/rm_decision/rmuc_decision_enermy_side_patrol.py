...
class StateMachine:
    ...
    def __init__(self, node: Node):
        ...
        self.center_cruising_list = [(11.7, -1.83),(11.47, 2.92),(9.59, 2.34),(10.37, -0.39)]  # 中心巡航列表
    ...
    def _load_configuration(self) -> None:
        ...
        self.enermy_position = self.node.get_parameter('enermy_position').value

    def update(self, game_state, remaining_time, self_health,
                auto_aiming_status, remaining_bullet, enemy_outpost_hp,
                 self_outpost_hp, self_base_hp, enermy_base_hp) -> None:
        ...
        if(game_state == 1):
            ...
            # 直接进入敌方区域(比赛时间多于180秒，敌方的前哨站无血量，己方基地血量较多，敌方基地血量已经低于2000)
            if self._hander_enermy_side(self,remaining_time, self_base_hp, enermy_base_hp):
                return
    ...
    def _hander_enermy_side(self,remaining_time, self_base_hp, enermy_base_hp, enemy_outpost_hp):
        "直接进入敌方位置"
        if(enermy_base_hp < 2000 and self_base_hp >= 4000 and remaining_time < 180 and enemy_outpost_hp <= 0):
            if(self.current_state != RobotState.GOING_ENERMY_SIDE):
                self._transition_to(RobotState.GOING_ENERMY_SIDE, self.enermy_position)
                return True
            elif(self.current_state == RobotState.GOING_ENERMY_SIDE):
                if(enermy_base_hp < 2000 and self_base_hp >= 4000 and remaining_time < 180 and enemy_outpost_hp <= 0):
                    return True
                else:
                    self.current_state == RobotState.IDLE
...
class Nav2DecisionNode(Node):
    ...
    def _declare_parameters(self) -> None:
        ...
        self.declare_parameter('enermy_position', [10.33, 0.5])  # 敌方位置
        ...
        self.enermy_base_hp = 0xff      # 敌方基地血量
    ...
    def _ref_data_callback(self, msg: RefereeData) -> None:
        ...
        self.enermy_base_hp = msg.enermy_base_hp
    ...
    def _update(self) -> None:
        ...
        self.state_machine.update(
            ...
            enermy_base_hp = self.enermy_base_hp,
        )
