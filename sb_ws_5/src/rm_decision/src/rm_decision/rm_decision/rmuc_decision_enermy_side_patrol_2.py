...
class StateMachine:
    ...
    def __init__(self, node: Node):
        ...
        if SELF_IS_RED: 
            self.center_cruising_list = [(11.50, 1.40),(10.46, 4.49),(9.25, 1.77),(11.26, -2.04)]  # 中心巡航列表
        else:
            self.center_cruising_list = [(16.24, 1.01),(15.35, 1.10)]  # 中心巡航列表
    ...
    def _hander_self_cruise(self,remaining_time,self_base_hp):
        "己方半场巡航"
        if(remaining_time < 120 or self_base_hp < 2500):
