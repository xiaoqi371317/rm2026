...
SELF_IS_RED = False # 己方是不是红方   蓝方 Done   红方未测试
...
class StateMachine:
    ...
    def __init__(self, node: Node):
        ...
        # center_cruising_list -> 己方防御
        if SELF_IS_RED:
            self.self_cruising_list = [(15.45, -5.92)]  # 己方巡航列表
            self.center_cruising_list = [(16.70, 2.93),(8.35, 2.27)]  # 中心巡航列表
            self.other_cruising_list = [(3.81, -2.72),(15.18, 3.20)]  # 敌方巡航列表
        else:
            self.self_cruising_list = [(4.35, 5.97)]  # 己方巡航列表
            self.center_cruising_list = [(4.81, -2.81),(3.22, -3.29), ]  # 中心巡航列表
