...
private:
  ...
  void followYawCallback(std_msgs::msg::Bool::SharedPtr msg);
  void publishControllerSelector(bool if_follow_yaw);
  void publishZeroVelocity();
  void publishTransform();
  bool zeroVelocityHoldActive() const;
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr if_follow_yaw_sub_;
  ...
  float spin_speed_;
  std::atomic<bool> if_follow_yaw_{false};
  std::atomic<double> zero_cmd_vel_until_sec_{0.0};
